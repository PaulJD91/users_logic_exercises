...
eriks_lottery_num_list = users["Erik"]["lottery_numbers"]
eriks_lottery_num_list_sorted = sorted(eriks_lottery_num_list)
...
users.update(
     {
  "Paul": {
    "twitter": "AngryPaul279",
    "lottery_numbers": [3, 7, 15, 23, 32, 37],
    "home_town": "Stirling",
    "pets": [
    {
      "name": "pippin",
